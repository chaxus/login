! function (e) {
            ...
            n = function (e) {
                ...
                for (; !e.end();) {
                    ...
                    if ("(" == i) n.push(i), t = "";
                        ...
                        if (/^\-\-.+/.test(t) && (s.name ? (s.alternative || (s.alternative = []), s.alternative
                                .push({
                                    name: t
                                })) : s.name = t), ")" == i) {
    ...
    function _(e) {
        let t, n = [],
            ...
            l = "";
        for (; !e.end();) {
            if (t = e.curr(), /[\('"`]/.test(t) && "\\" !== e.curr(-1)) i.length && "(" != t && t === s(i) ? i.pop() :
                i.push(t), l += t;
            else if ("@" == t) r.length || (l = l.trimLeft()), l.length && (r.push(o.text(l)), l = ""), r.push(b(e));
            else if (/[,)]/.test(t)) {
                if (i.length) ")" == t && i.pop(), l += t;
                else if (l.length && (r.length ? l.length && r.push(o.text(l)) : r.push(o.text((a = l).trim().length ?
                        u.number(+a) ? +a : a.trim() : a))), n.push(v(r)), [r, l] = [[], ""], ")" == t) break
            } else l += t;
            e.next()
        }
        var a;
    ...
    function v(e) {
        ...
        if ("text" == n.type && "text" == r.type) {
            let e = i(n.value),
                t = s(r.value);
            "string" == typeof n.value && "string" == typeof r.value && u.pair(e) && u.pair_of(e, t) && (n.value =
                n.value.slice(1), r.value = r.value.slice(0, r.value.length - 1))
        }
        return t
    }
    function b(e) {
        ...
        for (; !e.end() && ")" != (t = e.curr());) {
            if ("(" == t) {
                e.next(), n.name = s, n.arguments = _(e), /\d$/.test(s) && (n.name = s.split(/\d+/)[0], r = s.split(
                    /\D+/)[1]), r.length && n.arguments.unshift([{
                    type: "text",
                    value: r
            ...
            if (t = e.curr(), s && u.white_space(t)) e.next();
                ...
                if (s = !1, "\n" != t || u.white_space(e.curr(-1)))
                    if ("," != t || l.length) {
                        ...
                        "@" == t ? (n.value.length && (i[r].push(n), n = o.text()), i[r].push(b(e))) : u.white_space(
                            t) && u.white_space(e.curr(-1)) || ("(" == t && l.push(t), ")" == t && l.pop(), n.value +=
                            t)
    ...
    function w(e, t) {
        ...
        for (; !e.end() && "}" != (n = e.curr());)
            if (u.white_space(n)) e.next();
                ...
                if (r.selector) {
                    let n = j(e, t);
                    if ("@use" == n.property ? r.styles = r.styles.concat(n.value) : r.styles.push(n), "}" == e.curr())
                        break
                } else r.selector = k(e);
                e.next()
            } return r
    ...
    function U(e) {
        ...
        return e.includes("<svg") || (e = `<svg ${t}>${e}</svg>`), e.includes("xmlns") || (e = e.replace(
            /<svg([\s>])/, `<svg ${t}$1`)), e
    }
    function B(e = 0, t = e) {
                ...
                let t = function (e) {
                    ...
                    for (let e = 0; e < t.length; ++e) {
                        ...
                        if (X[i])
                            ...
                            "operator" == e && !r.length && /[^()]/.test(i) && /[^()]/.test(t) ? r += i : (r.length &&
                                (n.push({
                                    type: "number",
                                    value: r
                                }), r = ""), n.push({
    ...
    const ae = {
            ...
            heart: () => oe(e => {
                return ue(1.2 * (.75 * se(ne(e), 3)), 1.1 * (te(1 * e) * (13 / 18) - te(2 * e) * (5 / 18) -
                    te(3 * e) / 18 - te(4 * e) / 18 + .2), 180)
            }),
            bean: () => oe(e => {
        ...
        ce = {
            ...
            var: () => e => `var(${e})`,
            shape: () => memo("shape-function", (e = "", ...t) => (e = e.trim(), "function" == typeof ae[e] ? ae[e]
                (t) : ""))
        };
    ...
    function me(t) {
        ...
        for (; !n.end();) {
            let e = n.curr();
            "(" == e ? (i += e, s.push(e)) : ")" == e ? (i += e, s.length && s.pop()) : s.length ? i += e : de(e) ?
                (r.push(i), i = "", ge(n)) : i += e, n.next()
        }
        return i && r.push(i), r
    }
    let ye = [];
    ...
    var Me = Object.getOwnPropertyNames(Math).reduce((e, t) => (e[t] = (() => (...e) => "number" == typeof Math[t] ?
        Math[t] : Math[t].apply(null, e.map(V))), e), {});
    function Se(e) {
    ...
    class Oe {
        constructor(e) {
            this.tokens = e, this.rules = {}, this.props = {}, this.keyframes = {}, this.grid = null, this.coords = [],
                this.reset()
        }
        reset() {
            this.styles = {
            ...
            let r = e.map(e => {
                ...
                if ("func" == e.type) {
                    ...
                    if (r) {
                        ...
                        let s = e.arguments.map(e => r.lazy ? n => this.compose_argument(e, t, n) :
                            this.compose_argument(e, t, n));
                        return E(r, t, s)
                    }
                }
            });
                    ...
                    case "func":
                        {
                            ...
                            if (s) {
                                ...
                                let r = n.arguments.map(e => s.lazy ? n => this.compose_argument(e, t,
                                    n) : this.compose_argument(e, t));
                                e += E(s, t, r)
                            }
                        }
                }
        ...
        compose_rule(e, t, n) {
            ...
            let o = `${s}:${l};`;
            if (o = $e(s, o), "clip-path" == s && (o += ";overflow:hidden;"), "width" != s && "height" != s ||
                Ee(n) || (o += `--internal-cell-${s}:${l};`), ke[s]) {
                let t = ke[s](l, {
        ...
        compose(e, t) {
            this.coords.push(e), (t || this.tokens).forEach((t, n) => {
                ...
                switch (t.type) {
                    ...
                    case "pseudo":
                        {
                            t.selector.startsWith(":doodle") && (t.selector = t.selector.replace(
                                /^\:+doodle/, ":host"));
                            let n = Ee(t.selector);n && (t.skip = !0),
    ...
    customElements.define("css-doodle", class extends HTMLElement {
        ...
        connectedCallback() {
            setTimeout(() => {
                ...
                try {
                    ...
                    this.grid_size = q(this.getAttribute("grid")), (e = Le(n, this.grid_size)).grid &&
                        (this.grid_size = e.grid), this.build_grid(e)
                } catch (e) {
        ...
        build_grid(e) {
            ...
            this.doodle.innerHTML =
                `\n<style>${this.style_basic()}</style><style class="style-keyframes">${r}</style><style class="style-container">${this.style_size()}${s}${i}</style><style class="style-cells">${t||n?"":l}</style><div class="container"></div>`,
                this.doodle.querySelector(".container").appendChild(this.html_cells()), (t || n) &&
                setTimeout(() => {
        ...
        update(e) {
            ...
            t && (t = `@use:${t};`), e || (e = this.innerHTML), this.innerHTML = e, this.grid_size || (
                this.grid_size = q(this.getAttribute("grid")));
            ...
            if (n.grid) {
                ...
                if (s !== e || i !== t || l !== r) return Object.assign(this.grid_size, n.grid), this.build_grid(
                    n);
                ...
                if (l !== r || o !== s || u !== i) return Object.assign(this.grid_size, n), this.build_grid(
                    Le(C(t + e, this.extra), this.grid_size))
            }
            this.set_style(".style-keyframes", n.styles.keyframes), n.props.has_animation && (this.set_style(
                ".style-cells", ""), this.set_style(".style-container", "")), setTimeout(() => {
                this.set_style(".style-container", this.style_size() + n.styles.host + n.styles
                    .container), this.set_style(".style-cells", n.styles.cells)
            })
        }
        get grid() {
